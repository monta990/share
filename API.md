...
En los ejemplos usa tu dominio real. `share.cyalimentos.com` no es una URL real.
...
curl.exe -X POST `
  ...
  "https://share.cyalimentos.com/api/v1/upload"
```
...
$response = Invoke-RestMethod `
    -Uri "https://share.cyalimentos.com/api/v1/upload" `
    -Method Post `
    -Headers $headers `
    -Form $form
...
$url = 'https://share.cyalimentos.com/api/v1/upload';
$secret = 'pf_TU_SECRET';
...
```json
{
  ...
  "file": {
    ...
    "size": 245760,
    "sha256": "8d4c...91af",
    "url": "https://share.cyalimentos.com/f/AbCdEf123",
    "pin": "4119",
...
curl \
  -H "X-API-Key: pf_TU_SECRET" \
  "https://share.cyalimentos.com/api/v1/files/123"
```
...
Invoke-RestMethod `
  -Uri "https://share.cyalimentos.com/api/v1/files/123" `
  -Method Get `
  -Headers $headers
```
