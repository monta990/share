...
<div id="dropZone" class="drop-zone text-center mt-3" tabindex="0">
  ...
  <button id="chooseBtn" class="btn btn-primary px-4" type="button"><i class="bi bi-folder2-open me-2"></i><?=e($L['select'])?></button>
  <div class="small text-body-secondary mt-2"><?=e($L['available'])?> <strong><?=e((string)setting($db,'duration_hours',(string)$config['expiration_hours']))?> <?=e($L['hours'])?></strong>.</div>
...
<div id="selectedFileSummary" class="alert alert-info py-2 mt-3 mb-0 d-none" role="status" aria-live="polite"></div>
