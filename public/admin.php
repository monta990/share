...
?>
          ...
          <td style="min-width:220px">
            ...
            <div class="file-properties d-flex flex-wrap gap-1">
              ...
              <span class="badge rounded-pill file-property-pill <?=((int)$f['one_time']===1)?'text-bg-warning':'text-bg-secondary'?>" title="Enlace de un solo uso"><i class="bi bi-lightning-charge me-1"></i><?=((int)$f['one_time']===1)?'Un solo uso':'Multiuso'?></span>
